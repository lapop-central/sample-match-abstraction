...
panelfile <- paste0(rawdir,'panel/', country, '_netquest_recoded.csv')
...
excludefiles <- list(
  ...
  paste0('C:/Users/schadem/Box Sync/LAPOP Shared/working documents/maita/Coordination/IDB Online Crime/Data processing/Data/IADB+Argentina+Questionnaire+-+Netquest+v2_October+28%2C+2019_08.59.csv'),
...
write.csv(target.pruned,"pruned_target_190927.csv")
write.csv(set,"selected_IDs_190927.csv")
```
